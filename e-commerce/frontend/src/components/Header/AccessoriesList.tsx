...
const AccessoriesList = ({
  ...
  handleAccessoriesClose: handleAccessoriesClose,
}: {
  setAccessoriesToggle: any;
  handleAccessoriesClose: any;
}) => {
  return (
    <div
      onMouseEnter={() => setAccessoriesToggle(true)}
      onMouseLeave={handleAccessoriesClose}
    ...
    >
      ...
      <ul className="w-2/6 p-4">
        ...
        <Link to="/search" onClick={handleAccessoriesClose}>
